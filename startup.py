...
from app.database.models import User, Category, Book, SubCategory, BookShelf, Achievement, CompletedAchievement, YearlyPageCount, BookCover, Author, AuthorBook, Publisher, BookVersion
...
try:
    ...
    # Create Books
    books_data = [
    {'title': 'Book 1', 'main_category_id': 1},
    {'title': 'Book 2', 'main_category_id': 2},
    {'title': 'Book 3', 'main_category_id': 3},
    {'title': 'Book 4', 'main_category_id': 4},
    {'title': 'Book 5', 'main_category_id': 5},
    {'title': 'Book 6', 'main_category_id': 1},
    {'title': 'Book 7', 'main_category_id': 2},
    {'title': 'Book 8', 'main_category_id': 3},
    {'title': 'Book 9', 'main_category_id': 4},
    {'title': 'Book 10', 'main_category_id': 5},
]
    ...
    book_versions_data = [
    {'page_count': 300, 'is_ebook': False, 'publisher_id': 1, 'description': 'Description of Book 1', 'language': 'English',  "book_cover_id": 1, "book_id": 1},
    {'page_count': 400, 'is_ebook': True, 'publisher_id': 2,  'description': 'Description of Book 2', 'language': 'French',  "book_cover_id": 2, "book_id": 2},
    {'page_count': 250, 'is_ebook': False, 'publisher_id': 3, 'description': 'Description of Book 3', 'language': 'German',  "book_cover_id": 3, "book_id": 3},
    {'page_count': 350, 'is_ebook': True, 'publisher_id': 4,  'description': 'Description of Book 4', 'language': 'Spanish',  "book_cover_id": 4, "book_id": 4},
    {'page_count': 200, 'is_ebook': False, 'publisher_id': 5, 'description': 'Description of Book 5', 'language': 'Italian',  "book_cover_id": 1, "book_id": 5},
    {'page_count': 320, 'is_ebook': False, 'publisher_id': 6, 'description': 'Description of Book 6', 'language': 'English',  "book_cover_id": 2, "book_id": 6},
    {'page_count': 420, 'is_ebook': True, 'publisher_id': 6,  'description': 'Description of Book 7', 'language': 'French',  "book_cover_id": 3, "book_id": 7},
    {'page_count': 270, 'is_ebook': False, 'publisher_id': 6, 'description': 'Description of Book 8', 'language': 'German',  "book_cover_id": 4, "book_id": 8},
    {'page_count': 380, 'is_ebook': True, 'publisher_id': 1,  'description': 'Description of Book 9', 'language': 'Spanish',  "book_cover_id": 1, "book_id": 9},
    {'page_count': 220, 'is_ebook': False, 'publisher_id': 1, 'description': 'Description of Book 10', 'language': 'Italian',  "book_cover_id": 2, "book_id": 10},
]
    for book_version_data in book_versions_data:
        book_version = BookVersion(**book_version_data)
        db.add(book_version)
    ...
    # Create BookShelves
    bookshelves_data = [
        {'pages_read': 100, 'start_date': datetime(2023, 1, 1), 'finished_date': None, 'user_id': 1, 'book_version_id': 1, 'isFinished': False},
        {'pages_read': 150, 'start_date': datetime(2023, 2, 1), 'finished_date': None, 'user_id': 1, 'book_version_id': 2, 'isFinished': False},
        {'pages_read': 50, 'start_date': datetime(2023, 3, 1), 'finished_date': datetime(2023, 3, 7), 'user_id': 1, 'book_version_id': 3, 'isFinished': True},
        {'pages_read': 120, 'start_date': datetime(2023, 4, 1), 'finished_date': datetime(2023, 4, 15), 'user_id': 1, 'book_version_id': 4, 'isFinished': True},
        {'pages_read': 80, 'start_date': datetime(2023, 5, 1), 'finished_date': datetime(2023, 5, 20), 'user_id': 1, 'book_version_id': 5, 'isFinished': True},
        {'pages_read': 200, 'start_date': datetime(2023, 6, 1), 'finished_date': None, 'user_id': 1, 'book_version_id': 6, 'isFinished': False},
        {'pages_read': 90, 'start_date': datetime(2023, 7, 1), 'finished_date': None, 'user_id': 1, 'book_version_id': 7, 'isFinished': False},
        {'pages_read': 180, 'start_date': datetime(2023, 8, 1), 'finished_date': datetime(2023, 8, 12), 'user_id': 1, 'book_version_id': 8, 'isFinished': True},
        {'pages_read': 60, 'start_date': datetime(2023, 9, 1), 'finished_date': datetime(2023, 9, 18), 'user_id': 1, 'book_version_id': 9, 'isFinished': True},
        {'pages_read': 130, 'start_date': datetime(2023, 10, 1), 'finished_date': datetime(2023, 10, 5), 'user_id': 1, 'book_version_id': 10, 'isFinished': True}
    ]
